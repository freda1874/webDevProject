		...
		<div class="mainContainer">
			...
			<main>
				<div class="cardContainer">
					<h3 class="center">We have traveled the globe to find delicious recipes!</h3>	
				</div>	
				<div class="cardContainer">
					<h3 class="center">Please select a category to continue.</h3>	
				</div>				
				<div class="cardContainer">
					<image class="centerImage" src="images/globe.jpg">						
				</div>
