		...
		<div class="mainContainer">
			...
			<main>
				<div class="cardContainer">
					<h3 class="center">Admin Control Panel.</h3>	
				</div>	
				<div class="cardContainer">
					<h3 class="center"><a class="pink" href="addRecipe.php">Add A Recipe</a></h3>	
				</div>				
				<div class="cardContainer">
					<h3 class="center"><a class="pink" href="deleteRecipe.php">Delete A recipe</a></h3>							
				</div>
